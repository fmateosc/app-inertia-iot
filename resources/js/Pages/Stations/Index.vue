                        ...
                        <Table>
                            ...
                            >
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    ...
                                    >
                                        <i
                                            class="fas fa-map text-white-800"
                                            aria-hidden="true"
                                        ></i>
                                    </jet-button>
                                    ...
                                    <jet-button
                                        ...
                                        type="btn"
                                        v-on:click="
                                            activarDesactivar(station, 1)
                                        "
                                    >
                                        <i
                                            class="fas fa-heart text-white-800"
                                            aria-hidden="true"
                                        ></i>
                                    </jet-button>
...
export default defineComponent({
    ...
    methods: {
        activarDesactivar(station, userId) {
            Inertia.put(
                route("estaciones.activar-desactivar", { station: station }),
                userId
            );
        },
        toggleModal(station) {
        ...
        async geocodeInverse(lat, lon) {
            try {
                ...
                const res = await axios.post(
                    "https://iotspain.xyz/maps/geocode",
                    this.coordenadas
                );
